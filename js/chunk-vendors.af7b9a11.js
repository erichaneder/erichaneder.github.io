 ...
 * limitations under the License.
 */
function pu(t){t=ht(t,pc);const e=ht(t.firestore,_c),n=Tc(e);return ec(n,t._key).then(n=>Eu(e,t,n))}function gu(t){t=ht(t,dc);const e=ht(t.firestore,_c),n=Tc(e),r=new Jc(e);return su(t._query),nc(n,t._query).then(n=>new lu(e,r,t,n))}function mu(t,e,n){t=ht(t,pc);const r=ht(t.firestore,_c),i=ou(t.converter,e,n),s=Mc(r);return _u(r,[Fc(s,"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,xr.none())])}function yu(t,e,n,...r){t=ht(t,pc);const i=ht(t.firestore,_c),s=Mc(i);let o;return o="string"==typeof(e=(0,a.Ku)(e))||e instanceof Cc?$c(s,"updateDoc",t._key,e,n,r):jc(s,"updateDoc",t._key,e),_u(i,[o.toMutation(t._key,xr.exists(!0))])}function vu(t){return _u(ht(t.firestore,_c),[new $r(t._key,xr.none())])}function wu(t,e){const n=ht(t.firestore,_c),r=yc(t),i=ou(t.converter,e),s=Mc(t.firestore);return _u(n,[Fc(s,"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,xr.exists(!1))]).then(()=>r)}function bu(t,...e){t=(0,a.Ku)(t);let n={includeMetadataChanges:!1,source:"default"},r=0;"object"!=typeof e[r]||nu(e[r])||(n=e[r++]);const i={includeMetadataChanges:n.includeMetadataChanges,source:n.source};if(nu(e[r])){const t=e[r];e[r]=t.next?.bind(t),e[r+1]=t.error?.bind(t),e[r+2]=t.complete?.bind(t)}let s,o,c;if(t instanceof pc)o=ht(t.firestore,_c),c=Pn(t._key.path),s={next:n=>{e[r]&&e[r](Eu(o,t,n))},error:e[r+1],complete:e[r+2]};else{const n=ht(t,dc);o=ht(n.firestore,_c),c=n._query;const i=new Jc(o);s={next:t=>{e[r]&&e[r](new lu(o,i,n,t))},error:e[r+1],complete:e[r+2]},su(t._query)}const u=Tc(o);return tc(u,c,i,s)}function _u(t,e){const n=Tc(t);return rc(n,e)}function Eu(t,e,n){const r=n.docs.get(e._key),i=new Jc(t);return new cu(t,i,e._key,r,new au(n.hasPendingWrites,n.fromCache),e.converter)}function Tu(t){return t=ht(t,_c),Tc(t),new fu(t,e=>_u(t,e))
/**
 * @license
 * Copyright 2021 Google LLC
 *
